...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Group: CPS_
    // @Path: ../libraries/AP_CustomParams/AP_CustomParams.cpp
    GOBJECT(cps, "CPS_", AP_CustomParams),
    ...
    // @Range: -32768 32767
    // @User: Advanced
    //lock all parameters from being changed
    //GSCALAR(lock, "LOCK", LOCK_DEFAULT),
