...
protected:
    ...
    int32_t check_custom_params(const char *packet_id,int32_t packet_value, AP_CustomParams *ap);
    bool check_param_range(const char *packet_id, int32_t packet_value);
